...
t1 = advancedExponent(2, 0); // 1
t2 = advancedExponent(2, 1); // 2
t3 = advancedExponent(2, 2); // 4
t4 = advancedExponent(2, 3); // 8
t5 = advancedExponent(2, 4); // 16
t6 = advancedExponent(2, 5); // 32
t7 = advancedExponent(2, 6); // 64
t8 = advancedExponent(2, 7); // 128
t9 = advancedExponent(2, 8); // 256
t10 = advancedExponent(2, 9); // 512
t11 = advancedExponent(2, 10); // 1024
t12 = advancedExponent(2, 11); // 2048
t13 = advancedExponent(2, 12); // 4096
