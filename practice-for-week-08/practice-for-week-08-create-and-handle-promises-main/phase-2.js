...
function runOnTreadmill(timeLeft) {
  ...
  return new Promise((resolve, reject) => {
    if (timeLeft >= 500) {
      setTimeout(() => {
        console.log("done running in treadmill");
        resolve(timeLeft - 500), 500;
      });
    } else {
...
function workout(totalTime) {
  ...
  stretch(totalTime)
    ...
    .then((value) =>
      console.log(`done working out with ${value / 1000} seconds left`)
    )
